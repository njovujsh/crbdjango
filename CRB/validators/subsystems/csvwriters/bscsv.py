...
class ProcessCSVBS(processcsvs.ProcessCSV):
    def __init__(self, filename, dialect, row, headers, delimiter="|",response=None):
        super(ProcessCSVBS, self).__init__(filename, dialect,response=response)
...
class CSVBSValidated(pivalidatecsv.CSVPIValidated):
    def __init__(self, filename, dialect, row, headers, delimiter="|", response=None):
        super(CSVBSValidated, self).__init__(filename, dialect, row, headers, delimiter, response=response)
    ...
    def write_row_data(self, coldata, val):
        try:
            ...
            #print "BRANCH CODE ", self.st_field
