...
class ProcessCSVBC(processcsvs.ProcessCSV):
    def __init__(self, filename, dialect, row, headers, delimiter="|", response=None):
        super(ProcessCSVBC, self).__init__(filename, dialect,response=response)
...
class CSVBCValidated(pivalidatecsv.CSVPIValidated):
    def __init__(self,filename, dialect, row, headers, delimiter=",",response=None):
        super(CSVBCValidated, self).__init__(filename, dialect,delimiter,headers,response=response)
    ...
    def write_row_data(self, coldata, val):
        try:
            ...
            self.ccn_field = self.load_validated_field(self.validated_field.get("Borrowers_Client_Number"))
            self.picc_field = self.load_validated_field(self.validated_field.get("PI_Client_Classification"))
            self.carn_field = self.load_validated_field(self.validated_field.get("Cheque_Account_Reference_Number"))
            self.caod_field = self.load_validated_field(self.validated_field.get("Cheque_Account_Opened_Date"))
            self.cac_field = self.load_validated_field(self.validated_field.get("Cheque_Account_Classification"))
            self.cat_field = self.load_validated_field(self.validated_field.get("Cheque_Account_Type"))
            self.cn_field = self.load_validated_field(self.validated_field.get("Cheque_Number"))
            self.ca_field = self.load_validated_field(self.validated_field.get("Cheque_Amount"))
            self.cc_field = self.load_validated_field(self.validated_field.get("Cheque_Currency"))
            self.bnop_field = self.load_validated_field(self.validated_field.get("Beneficiary_Name_Or_Payee"))
            self.cbd_field = self.load_validated_field(self.validated_field.get("Cheque_Bounce_Date"))
            self.cabr_field = self.load_validated_field(self.validated_field.get("Cheque_Account_Bounce_Reason"))
            #print "BIC ", self.cat_field
            ...
            for data in coldata:
                self.writer.writerow([
                            ...
                            self.value_in(smart_str(unicode(data.Borrowers_Client_Number)), self.ccn_field),
                            self.value_in(smart_str(unicode(data.PI_Client_Classification)), self.picc_field),
                            self.value_in(smart_str(unicode(data.Cheque_Account_Reference_Number)),self.carn_field),
                            self.value_in(smart_str(unicode(data.Cheque_Account_Opened_Date)),self.caod_field),
                            self.value_in(smart_str(unicode(data.Cheque_Account_Classification)),self.cac_field),
                            self.value_in(smart_str(unicode(data.Cheque_Account_Type)), self.cat_field),
                            self.value_in(smart_str(unicode(data.Cheque_Number)),self.cn_field),
                            self.value_in(smart_str(unicode(data.Cheque_Amount)),self.ca_field),
                            self.value_in(smart_str(unicode(data.Cheque_Currency)),self.cc_field),
                            self.value_in(smart_str(unicode(data.Beneficiary_Name_Or_Payee)), self.bnop_field),
                            self.value_in(smart_str(unicode(data.Cheque_Bounce_Date)),self.cbd_field),
                            self.value_in(smart_str(unicode(data.Cheque_Account_Bounce_Reason)),self.cabr_field),
